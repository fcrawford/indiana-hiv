    ...
    sidebarPanel(
      tabsetPanel( #type="tabs", 
        ...
        tabPanel("Parameters", 
          ...
          includeMarkdown("content/transmissionrate.md"),
          sliderInput(inputId="beta_scale", "Transmission reduction factor", 
                      min=beta_scale_min, max=beta_scale_max, value=beta_scale_init, step=0.01)),
        tabPanel("Smoothers",
