...
myred   = make_transparent(Reds[6],   0.3)
mygreen = make_transparent(Greens[7], 0.3)
myblue  = make_transparent(Blues[6],  0.3)
mygray  = make_transparent(Greys[6],  0.3)
myorange = make_transparent(Oranges[7], 0.3)
mypurple = make_transparent(Purples[7], 0.3)


mydarkred   = make_transparent(Reds[6],   0.5)
mydarkgreen = make_transparent(Greens[7], 0.5)
mydarkblue  = make_transparent(Blues[6],  0.5)
mydarkgray  = make_transparent(Greys[6],  0.5)
mydarkorange = make_transparent(Oranges[6], 0.5)
mydarkpurple = make_transparent(Purples[7], 0.5)
